<div class="card-header bg-primary text-white">Laporan Sisa Stok</div>
<div class="card-body">
	<div class="table-container">
		<table class="table table-bordered table-sm">
			<thead>
				<tr>
					<th scope="col" class="btn-dark" style="width: 25%;" data-toggle="modal" data-target="#stockReportModal">Tanggal</th>
					<th scope="col" style="width: 30%" id="supplier-name-header-table" sort="NULL" class="btn-dark">Supplier</th>
					<th scope="col" style="width: 30%" id="drug-name-header-table" sort="NULL" class="btn-dark">Nama Obat</th>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="stockReportModalLabel">
...
<script src="scripts/pharmacist/script-stock-report.js"></script>