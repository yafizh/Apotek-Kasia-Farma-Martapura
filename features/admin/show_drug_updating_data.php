...
<div class="card-header bg-primary text-white">Riwayat Pengeditan Data Obat</div>
<div class="card-body">
...
<!-- Modal -->
<div class="modal fade" id="sellModal" data-keyboard="false" tabindex="-1" aria-labelledby="sellModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
				<div class="text-center"><h6>Pengeditan</h6></div>
				<hr>
				<div class="d-flex">
					<div id="date" class="w-50 text-left"></div>
					<div id="time" class="w-50 text-right"></div>
				</div>
				<br>
				<div id="edited" class="text-left">
					
				</div>
				<hr>
				<div class="text-center"><h6>Data Obat Saat Ini</h6></div>
				<hr>
				<div id="recenly" class="text-left"></div>
			</div>
		</div>
	</div>
</div>
...
<script src="scripts/admin/script-show-drug-updating-data.js"></script>