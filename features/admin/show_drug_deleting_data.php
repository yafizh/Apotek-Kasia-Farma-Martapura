...
<div class="card-header bg-primary text-white">Riwayat Penghapusan Data Obat</div>
<div class="card-body">
		...
		<table class="table table-bordered table-sm">
			<thead>
				<tr>
					...
					<th scope="col">Penghapus</th>
					<th scope="col">Pulihkan</th>
				</tr>
			</thead>
			<tbody>
			</tbody>
...
<!-- Modal -->
<div class="modal fade" id="restoreModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="restoreModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bg-danger text-white">
				<h5 class="modal-title" id="restoreModalLabel">Pulihkan</h5>
			</div>
			<div class="modal-body"></div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
				<button type="submit" id="restore" class="btn btn-success" data-dismiss="modal">Pulihkan</button>
			</div>
		</div>
	</div>
</div>
...
<script src="scripts/admin/script-show-drug-deleting-data.js"></script>